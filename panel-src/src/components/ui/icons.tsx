...
export function IconSidebarFabSol({ size = 20, ...props }: IconProps) {
  return (
    <svg {...baseSvgProps} width={size} height={size} {...props}>
      <path d="M12 3v3" />
      <path d="M12 18v3" />
...
export function IconSidebarFabKim({ size = 20, ...props }: IconProps) {
  return (
    <svg {...baseSvgProps} width={size} height={size} {...props}>
...
export function IconSidebarMoonshot({ size = 20, ...props }: IconProps) {
  return (
    <svg {...baseSvgProps} width={size} height={size} {...props}>
...
export function IconSidebarClaude({ size = 20, ...props }: IconProps) {
  return (
    <svg {...baseSvgProps} width={size} height={size} {...props}>
      <path d="M12 3 13.2 9.2 20 12 13.2 14.8 12 21 10.8 14.8 4 12 10.8 9.2z" />
    </svg>
  );
}
